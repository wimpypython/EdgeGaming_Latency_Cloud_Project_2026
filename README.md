...
### Team Members:
*   **Atharva Phalak** - AI & Data Engineering 
*   **Dhyaan Bharadwaj** - AWS Cloud Infrastructure 
...
* **The Physical Shortcut (AWS Wavelength):** Game server containers are hosted directly inside local 5G telecom towers,
  vastly reducing the physical distance data must travel between the player and the server.
